...
ArtifactType = Literal[
    ...
    "candidate",
    "judgement",
    "code",  # 增加code类型，用于存储代码
    "other",
]
NodeStatus = Literal["pending", "ready", "running", "success", "failed"]  # 节点在调度器眼里的生命周期
NodeExecutionStatus = Literal["success", "failed", "partial"]  # 节点执行结果状态
TranscriptKind = Literal["info", "model", "capability", "agent", "result", "error"]  # 日志类型
