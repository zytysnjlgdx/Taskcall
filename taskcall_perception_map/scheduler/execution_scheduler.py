...
class ExecutionScheduler:
    ...
    async def run(
        ...
        *,
        ...
        snapshot = self.session_store.create(plan, session_id=session_id)
        ...
        while True:
            ...
            # pending 变成 ready。
            sync_ready_states(plan, current_snapshot.node_states)
            for state in current_snapshot.node_states.values():
