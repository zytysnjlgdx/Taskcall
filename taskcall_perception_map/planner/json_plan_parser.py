...
from taskcall_perception_map.planner.schema_adapter import convert_task_topology_schema_to_plan_graph
...
class JSONPlannerResponseParser:
    ...
    def parse(self, text: str) -> PlanGraph:
        ...
        question_text = _read_str(
            graph_payload,
            "question_text",
            fallback=graph_payload.get("question_text", ""),
        )
    ...
    def _parse_node(self, raw_node: Any) -> PlanNode:
        ...
        return PlanNode(
            ...
            instruction=instruction,  # 这里会接受到None
